...
export default class stellaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `SRecord`
	 * labeled alternative in `stellaParser.expr`.
	 * @param ctx the parse tree
	 */
	enterSRecord?: (ctx: SRecordContext) => void;
	/**
	 * Exit a parse tree produced by the `SRecord`
	 * labeled alternative in `stellaParser.expr`.
	 * @param ctx the parse tree
	 */
	exitSRecord?: (ctx: SRecordContext) => void;
	/**
